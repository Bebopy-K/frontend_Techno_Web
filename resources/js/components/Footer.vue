<template>
  ...
  >
    <div class="p-10 bg-muted/50 dark:bg-card border rounded-2xl">
      ...
      >
        <div class="col-span-full xl:col-span-2 flex items-center">
          <a href="/" class="flex items-center gap-2">
            <img 
              src="../assets/full_icon.svg" 
              alt="Logo" 
              class="h-20 sm:h-35 w-auto object-contain invert dark:invert-0 transition-all duration-200" 
            />
          </a>
        </div>
